...
const Card = (props:CardProps) => {
    ...
    const styles = dynamicStyles(colors, fontSizes, widthTextWithSwitch);
        ...
        <>
            ...
            {props.hasSwitch && (
                    <Switch
                        ...
                        thumbColor={props.thumbColor ? colors.baseColor : colors.secondary}
...
const dynamicStyles = (colors: Colors, fontSizes: FontSize, widthTextWithSwitch: number) => {
